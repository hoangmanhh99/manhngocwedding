...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1295: () => new AudioContext(),
      _1296: (x0,x1) => x0.createMediaElementSource(x1),
      _1297: x0 => x0.createStereoPanner(),
      _1298: (x0,x1) => x0.connect(x1),
      _1299: x0 => x0.load(),
      _1300: x0 => x0.remove(),
      _1301: x0 => x0.play(),
      _1302: x0 => x0.pause(),
      ...
      _1434: x0 => x0.abort(),
      _1435: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1436: (x0,x1) => globalThis.fetch(x0,x1),
      _1437: (x0,x1) => x0.get(x1),
      _1438: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1438(f,arguments.length,x0,x1,x2) }),
      _1439: (x0,x1) => x0.forEach(x1),
      _1440: x0 => x0.getReader(),
      _1441: x0 => x0.read(),
      _1442: x0 => x0.cancel(),
      _1443: () => new XMLHttpRequest(),
      _1444: (x0,x1,x2) => x0.open(x1,x2),
      _1445: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1446: x0 => x0.abort(),
      _1447: (x0,x1) => x0.send(x1),
      _1448: x0 => x0.send(),
      _1449: x0 => x0.getAllResponseHeaders(),
      ...
      _1624: x0 => x0.readyState,
      _1626: (x0,x1) => { x0.timeout = x1 },
      _1628: (x0,x1) => { x0.withCredentials = x1 },
      _1629: x0 => x0.upload,
      _1630: x0 => x0.responseURL,
      _1631: x0 => x0.status,
      _1632: x0 => x0.statusText,
      ...
      _2322: (x0,x1) => { x0.crossOrigin = x1 },
      _2325: (x0,x1) => { x0.preload = x1 },
      _2329: x0 => x0.currentTime,
      _2330: (x0,x1) => { x0.currentTime = x1 },
      _2331: x0 => x0.duration,
      _2336: (x0,x1) => { x0.playbackRate = x1 },
      _2345: (x0,x1) => { x0.loop = x1 },
      _2349: (x0,x1) => { x0.volume = x1 },
      _2366: x0 => x0.code,
      _2367: x0 => x0.message,
      _3415: () => globalThis.window,
      _3477: x0 => x0.navigator,
      _3866: x0 => x0.userAgent,
      _5464: x0 => x0.destination,
      _6019: x0 => x0.signal,
      _6093: () => globalThis.document,
      _7854: x0 => x0.value,
      _7856: x0 => x0.done,
      _8558: x0 => x0.url,
      _8560: x0 => x0.status,
